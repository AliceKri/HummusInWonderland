        ...
        protected override void Seed(HummhusInWonderlandContext context)
        {
           var menu = new List<Product>
            ...
            var customer = new List<Customer>
            {
                ...
                Gender = Gender.זכר, Email = "halleldaniel@gmail.com", City ="ראש העין", Street = "חבצלת", Password ="1234", PhoneNumber = "0543034020"},
                new Customer {CustomerID = 2, FirstName = "עמית", LastName ="הררי", BirthDate = DateTime.Parse("1993-11-19") ,
                Gender = Gender.זכר, Email = "amit.harari93@gmail.com", City ="תל אביב", Street = "אבן גבירול", Password ="1234", PhoneNumber = "0528465750"},
                new Customer {CustomerID = 3, FirstName = "עליסה", LastName ="קריבורוצקי", BirthDate = DateTime.Parse("1994-03-11") ,
                Gender = Gender.נקבה, Email = "alisa6450@gmail.com", City ="באר שבע", Street = "גלזמן", Password ="1234", PhoneNumber = "0543016142"},
                new Customer {CustomerID = 4, FirstName = "שחר", LastName ="חסון", BirthDate = DateTime.Parse("1980-09-17") ,
                Gender = Gender.זכר, Email = "shaharhason@gmail.com", City ="תימן", Street = "תימנים", Password ="1234", PhoneNumber = "0507878787"},
                new Customer {CustomerID = 5, FirstName = "אדיר", LastName ="מילר", BirthDate = DateTime.Parse("1983-04-12") ,
                Gender = Gender.זכר, Email = "adirmiller@gmail.com", City ="פתח תקווה", Street = "כלנית", Password ="1234", PhoneNumber = "0526767489"},
                new Customer {CustomerID = 6, FirstName = "בר", LastName ="רפאלי", BirthDate = DateTime.Parse("1985-09-13"),
                Gender = Gender.נקבה, Email = "barrefaeli@gmail.com", City ="תל אביב", Street = "הדוגמנויות", Password ="1234", PhoneNumber = "0526839072"},
                new Customer {CustomerID = 7, FirstName = "גל", LastName ="גדות", BirthDate = DateTime.Parse("1986-02-18") ,
                Gender = Gender.נקבה, Email = "galgadot@gmail.com", City ="תל אביב", Street = "הדוגמנויות", Password ="1234", PhoneNumber = "0508362973"}
            };
